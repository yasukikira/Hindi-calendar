...
import { X, Sun, Moon, Calendar as CalendarIcon, MapPin, MessageCircle, CalendarPlus, AlertTriangle, Trash2 } from 'lucide-react';
...
const DetailPanel = ({ date, onClose, events, onAddEvent, onDeleteEvent, lang, darkMode }) => {
  const t = DATA[lang] || DATA['en'];
